================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Bon プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Bon には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Bon アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Bon.h
   ...
   CBonApp アプリケーション クラスを宣言します。

Bon.cpp
   これは、アプリケーション クラス CBonApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Bon.ico
   ...
   アイコンはメイン リソース ファイル Bon.rc に含まれていま
   す。
...
BonDlg.h, BonDlg.cpp - ダイアログ
   これらのファイルは CBonDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Bon.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Bon.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
